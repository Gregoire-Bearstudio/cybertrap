    ...
    var slide = function (direction) {
        ...
        switch (object.type) {
            ...
            case"glide":
                ...
                $('.slide-container .detail-box').css('bottom', '-' + container_height + '%');
                $('.slide-container .main-image-box').css('top', '-300px');
...
// @prepros-prepend ../vendor/slideWiz/js/framework/slideWiz.js
// @prepros-prepend ../vendor/OwlCarousel2-2.3.4/dist/owl.carousel.min.js

var nav = document.getElementById('nav'); 
window.onscroll = function(){
	if (window.pageYOffset >100) {
		nav.className += " solid-nav";
	}
  	else{
	...
	$('.slideWiz').slideWiz(
        {
            ...
            file : [
                {
                    src: {
                    	main: "assets/images/laby.jpg",
                        cover: "assets/images/Alexandre.jpg"
                    },
                    title: 'Alexandre Nugues',
                    desc: 'Infographiste \n',
                    button: {
                        text: 'Download',
                        url: 'https://github.com/iamwizzdom/slideWiz',
                        class: 'btn btn-medium btn-primary bt-1',
                        color: '#3781ce'
                    }
                },
                {
                    src: {
                        ...
                        cover: "assets/images/David.jpg"
                    },
                    title: 'David Brunel',
                    desc: 'Modélisateur 3D \n',
                    button: {
                        text: 'Goal.com',
                        url: 'https://github.com/iamwizzdom/slideWiz',
                ...
                },
                {
                    src: {
                        ...
                        cover: "assets/images/Fabien.jpg"
                    },
                    title: 'Fabien Essid',
                    desc: 'Développeur Unity \n',
                    button: {
                        text: 'SuperSports',
                        url: 'https://github.com/iamwizzdom/slideWiz',
                        class: 'btn btn-medium btn-primary',
                ...
                },
                {
                    src: {
                        main: "https://picsum.photos/1920/1200?image=726",
                        cover: "assets/images/Damien.jpg"
                    },
                    title: 'Damien Jobard Siejak',
                    desc: 'Rédacteur web \n',
                    button: {
                        text: 'NBA.com',
                        url: false,
                ...
                },
                {
                    src: {
                        main: "https://picsum.photos/1920/1200?image=726",
                        cover: "assets/images/Gregoire.jpg"
                    },
                    title: 'Grégoire Protas',
